     ...
     <div className="max-w-3xl mx-auto space-y-32">
       ...
       >
         <h1 className="text-2xl md:text-4xl font-bold mb-6 text-gray-900">
           &ldquo;예술가의 모든 순간이 작품이 되는 곳&rdquo;
         </h1>
       </div>
       ...
       >
         <div className="grid md:grid-cols-3 gap-8 mt-20">
           <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
             <h3 className="text-xl font-bold mb-4 text-gray-900">지원사업 관리</h3>
           ...
           <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
             <h3 className="text-xl font-bold mb-4 text-gray-900">포트폴리오 & NFT</h3>
             <div className="text-gray-600 text-left space-y-2">
           ...
           <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
             <h3 className="text-xl font-bold mb-4 text-gray-900">커뮤니티</h3>
             <div className="text-gray-600 text-left space-y-2">
