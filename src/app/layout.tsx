...
export const metadata: Metadata = {
 title: {
   default: '예술인을 위한 올인원 플랫폼 | 아트레스트',
   template: '%s | ARTREST'
 },
 description: '1,321개의 정부지원사업부터 공모전, NFT 포트폴리오 관리까지 예술인을 위한 모든 기회를 한곳에서. AI가 맞춤형 지원사업과 공모전을 추천해드립니다.',
 keywords: ['아트레스트', '예술인', '공모전', '지원사업', '정부지원사업', '보조금', '포트폴리오', 'NFT', '갤러리', '예술인커뮤니티'],
 authors: [{ name: 'ARTREST' }],
 creator: 'ARTREST',
 publisher: 'ARTREST',
 openGraph: {
   title: '예술인을 위한 올인원 플랫폼 | 아트레스트',
 ...
 verification: {
   google: 'QpcOCXVXvcKBBVwj90_Ot8HCqH-2EpZ_9HQbOriYzzw'
 },
}
